...
import Loading from "./Loading/Loading"; import "../styles/Accueil.css";
    ...
    <div onLoad={load} className={chargement ? "scroll" : "no-scroll"}>
      ...
      <div className="background-accueil">
        <section className="accueil-part1">
          ...
          <img className="accueil-image1" src={require('../images/Logo_fiverr_blanc.png')} alt="image1" />
        </section>
        <section className="accueil-part2">
          <article className="accueil-ou">quoi qui</article>
          <img className="accueil-image2" src={require('../images/Logo_fiverr_blanc.png')} alt="image1" />
        </section>
